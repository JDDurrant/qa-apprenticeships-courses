...
the CGDatabase database on a named MS SQL server instance that is installed on
the local machine.  This is the database that is needed to answer the questions
in the City & Guilds SQL Language assessment.
