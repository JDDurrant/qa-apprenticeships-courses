...
public class DeclaringVariables {
	...
	public static void main(String[] args) {
		...
		// Task 1
		// Declare a variable of type int call it 'age'. Do not intialise it.
		int age;
