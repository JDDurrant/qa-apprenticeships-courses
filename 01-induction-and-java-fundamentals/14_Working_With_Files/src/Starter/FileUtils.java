...
public class FileUtils {
	...
	public static String lastLineInFile(String inputFile) throws IOException {
		return "";
	}
	...
	public static void convertFileToUpperCase(String inputFile, String outputFile) throws IOException {
	...
	public static int linesThatStartWith(String inputFile, String match) throws IOException {
	...
	public static int linesThatStartWithCaseInsensitive(String inputFile, String match) throws IOException {
	...
	// The file to be searched is the input file.
	// The search should ignore case.
	public static int linesThatContainCaseInsensitive(String inputFile, String match) throws IOException {
